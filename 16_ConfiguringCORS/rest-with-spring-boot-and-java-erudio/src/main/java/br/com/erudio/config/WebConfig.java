...
// Diz ao Spring Boot que quando estiver carregando a aplicação, subindo o contexto, ele
// precisa ler esta classe porque nela vai encontrar configurações sobre o compartamento da aplicação
@Configuration
