...
public class DozerConverterTest_Book {
    ...
    public void parseEntityToVOTest() {
        ...
        assertEquals(new Date(2022, 1, 1, 0, 0), output.getLaunchDate());
    ...
    public void parseEntityListToVOListTest() {
        ...
        assertEquals(new Date(2022, 1, 1, 0, 0), outputZero.getLaunchDate());
        ...
        assertEquals(new Date(2023, 1, 1, 0, 0), outputSeven.getLaunchDate());
        ...
        assertEquals(new Date(2022, 1, 1, 0, 0), outputTwelve.getLaunchDate());
